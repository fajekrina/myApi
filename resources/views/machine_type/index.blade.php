        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Machine Types</h4>
                            <a href="{{ route('machine_type.create') }}" type="button" class="btn mb-1 btn-primary">Add New
                                Data</a>
                                    ...
                                    <tbody>
                                        @foreach ($machine_types as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        <span><a href="{{ route('machine_type.show', $item->id) }}"
                                                                class="btn btn-info"><i class="fa fa-eye"></i></a></span>
                                                        <span><a href="{{ route('machine_type.edit', $item->id) }}"
                                                                class="btn btn-warning"><i
                                                                    class="fa fa-pencil"></i></a></span>
                                                        @if(Auth::user()->role == 'super_admin')            
                                                        <form action="{{ route('machine_type.destroy', $item->id) }}"
                                                            method="post">
                                                            @method('delete')
                                                            @csrf
