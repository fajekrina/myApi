        ...
        <div class="row page-titles mx-0">
            <div class="col p-md-0">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="{{ route('machine_type.edit', $machine_type->id) }}">Edit</a></li>
                </ol>
            </div>
        </div>
        <!-- row -->
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Edit Machine Type</h4>
                            <div class="basic-form">
                                <form action="{{ route('machine_type.update', $machine_type->id) }}" method="POST">
                                    @method('PUT')
                                    @csrf
                                    <div class="form-row">
                                      <div class="form-group col-md-12">
                                        ...
                                        <input type="text" class="form-control @error('type_name') is-invalid @enderror" id="type_name"
                                          name="type_name" value="{{ $machine_type->type_name }}" required>
                                        @error('type_name')
                                    ...
                                    <div class="form-row">
                                      <div class="form-group col-md-12">
                                          ...
                                          <textarea name="type_description" id="type_description" class="form-control @error('type_description') is-invalid @enderror">{{ $machine_type->type_description }}</textarea>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-12">
                                          ...
                                          <input type="text" class="form-control @error('max_operating_capacity') is-invalid @enderror" id="max_operating_capacity"
                                            name="max_operating_capacity" value="{{ $machine_type->max_operating_capacity }}">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-12">
                                          ...
                                          <input type="text" class="form-control @error('power_requirements') is-invalid @enderror" id="power_requirements"
                                            name="power_requirements" value="{{ $machine_type->power_requirements }}">
                                    ...
                                    <div class="form-row">
                                      <div class="form-group col-md-12">
                                          ...
                                          <textarea name="safety_guidelines" id="safety_guidelines" class="form-control @error('safety_guidelines') is-invalid @enderror">{{ $machine_type->safety_guidelines }}</textarea>
