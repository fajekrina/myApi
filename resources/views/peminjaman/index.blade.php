                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="{{ route('peminjaman.create') }}" type="button" class="btn mb-1 btn-primary">Add New
                                Data</a>
                                    ...
                                    <tbody>
                                        @foreach ($peminjamans as $item)
                                            <tr>
                                                ...
                                                <td>{{ \Carbon\Carbon::parse($item->tgl_awal)->format('d/m/Y h:m:s') }}</td>
                                                <td>{{ \Carbon\Carbon::parse($item->tgl_akhir)->format('d/m/Y h:m:s') }}</td>
                                                <td>{{ \Carbon\Carbon::parse($item->created_at)->format('d/m/Y h:m:s') }}</td>
                                                <td>{{ \Carbon\Carbon::parse($item->updated_at)->format('d/m/Y h:m:s') }}</td>
                                                <td>
                                                    <div class="d-flex">
                                                        <span><a href="{{ route('peminjaman.show', $item->id) }}"
                                                                class="btn btn-info"><i class="fa fa-eye"></i></a></span>
                                                        <span><a href="{{ route('peminjaman.edit', $item->id) }}"
