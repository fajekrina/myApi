        ...
        <div class="row page-titles mx-0">
            <div class="col p-md-0">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="{{ route('machine_brand.update', $machine_brand->id) }}">Edit</a></li>
                </ol>
            </div>
        </div>
        <!-- row -->
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Edit Machine Brand</h4>
                            <div class="basic-form">
                                <form action="{{ route('machine_brand.update', $machine_brand->id) }}" method="POST">
                                    @method('PUT')
                                    @csrf
                                    <div class="form-row">
                                      <div class="form-group col-md-12">
                                        ...
                                        <input type="text" class="form-control @error('brand_name') is-invalid @enderror" id="brand_name"
                                          name="brand_name" value="{{ $machine_brand->brand_name }}" required>
                                        @error('brand_name')
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-12">
                                          ...
                                          <input type="text" class="form-control @error('country_of_origin') is-invalid @enderror" id="country_of_origin"
                                            name="country_of_origin" value="{{ $machine_brand->country_of_origin }}" required>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-12">
                                          ...
                                          <input type="text" class="form-control @error('contact_information_email') is-invalid @enderror" id="contact_information_email"
                                            name="contact_information_email" value="{{ $machine_brand->contact_information_email }}">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-12">
                                          ...
                                          <input type="text" class="form-control @error('contact_information_phone') is-invalid @enderror" id="contact_information_phone"
                                            name="contact_information_phone" value="{{ $machine_brand->contact_information_phone }}">
