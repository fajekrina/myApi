        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Mobils</h4>
                            <a href="{{ route('mobil.create') }}" type="button" class="btn mb-1 btn-primary">Add New
                                Data</a>
                                    ...
                                    <tbody>
                                        @foreach ($mobils as $item)
                                            <tr>
                                                ...
                                                <td>Rp{{ number_format($item->tarif_harian) }}</td>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        <span><a href="{{ route('mobil.show', $item->id) }}"
                                                                class="btn btn-info"><i class="fa fa-eye"></i></a></span>
                                                        <span><a href="{{ route('mobil.edit', $item->id) }}"
